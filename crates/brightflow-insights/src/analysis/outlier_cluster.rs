...
mod tests {
    ...
    fn test_find_outlier_clusters() {
        ...
        let period_labels: Vec<Option<String>> = vec![
            Some("2023-01".to_string()), Some("2023-01".to_string()),
            Some("2023-02".to_string()), Some("2023-02".to_string()),
            Some("2023-03".to_string()), Some("2023-03".to_string()),
            Some("2023-04".to_string()), Some("2023-04".to_string()),
            Some("2023-05".to_string()), Some("2023-05".to_string()),
        ];
        ...
        assert!(cluster.columns.contains(&"Sales".to_string()), "Expected Sales in cluster");
        assert!(cluster.columns.contains(&"Profit".to_string()), "Expected Profit in cluster");
